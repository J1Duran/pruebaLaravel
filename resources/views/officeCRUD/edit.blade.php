...
@section('content')
    ...
    {!! Form::model($office, ['method' => 'PATCH','route' => ['officeCRUD.update', $office->officeCode]]) !!}
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>AdressLine1:</strong>
                {!! Form::textarea('addressLine1', null, array('placeholder' => 'adressLine1','class' => 'form-control','style'=>'height:100px')) !!}
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::textarea('addressLine2', null, array('placeholder' => 'adressLine2','class' => 'form-control','style'=>'height:100px')) !!}
            </div>
        </div>
